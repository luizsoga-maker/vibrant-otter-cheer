          ...
          <>
            ...
            <div className="space-y-2">
              ...
              {props.features?.map((feature: any, idx: number) => (
                <div key={idx} className="space-y-2 p-3 border rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      value={feature.icon || ''}
                      onChange={(e) => handleArrayChange('features', idx, { ...feature, icon: e.target.value })}
                      placeholder="Icon (e.g., heart, star, check)"
                    />
                    <Textarea
              ...
              <Button
                variant="outline"
                size="sm"
                onClick={() => addArrayItem('features', { title: '', icon: '', description: '' })}
              >
                <Plus className="h-4 w-4 mr-2" />
                Add Feature
              </Button>
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              {props.services?.map((service: any, idx: number) => (
                <div key={idx} className="space-y-2 p-3 border rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      value={service.icon || ''}
                      onChange={(e) => handleArrayChange('services', idx, { ...service, icon: e.target.value })}
                      placeholder="Icon (e.g., stethoscope, heart, brain)"
                    />
                    <Textarea
              ...
              <Button
                variant="outline"
                size="sm"
                onClick={() => addArrayItem('services', { title: '', icon: '', description: '', price: '' })}
              >
                <Plus className="h-4 w-4 mr-2" />
                Add Service
              </Button>
                ...
                <div key={idx} className="space-y-2 p-3 border rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="Role (e.g., Patient, Parent)"
                    />
                    <Textarea
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <Button
                ...
                size="sm"
                onClick={() => {
                  const newLinks = [...(props.socialLinks || []), { platform: '', url: '' }];
                  handleChange('socialLinks', newLinks);
                }}
              >
                <Plus className="h-4 w-4 mr-2" />
